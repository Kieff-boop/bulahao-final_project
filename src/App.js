...
function App() {
  ...
  return (
    <div className={darkMode ? 'dark' : ''}>
      <div
        className="min-h-screen bg-cover bg-center bg-no-repeat p-[50px_5%]"
        style={{
      ...
      >
        <div
          className="relative min-h-[calc(100vh-100px)] rounded-[30px] flex flex-col backdrop-blur"
          style={{
            background: darkMode
        ...
        >
          <header
            className={`w-full px-[5%] py-[25px] flex justify-between items-center z-10 sticky top-0 rounded-t-[30px] border-b-2 backdrop-blur-xl
            ${darkMode ? 'bg-white/10 border-white/30' : 'bg-black/10 border-black/20'}`}
          >
            <button
              onClick={() => setActivePage('home')}
              className={`text-[30px] font-semibold cursor-pointer bg-transparent border-none ${darkMode ? 'text-white' : 'text-forestgreen'}`}
            >
              Portfolio!
            </button>
            ...
            <nav className="flex items-center">
              {['home', 'about', 'skills', 'education', 'experience', 'contact'].map((page) => (
                <button
                  ...
                  className={`text-[18px] font-medium ml-[35px] border-b-2 transition-all duration-300 capitalize bg-transparent border-t-0 border-l-0 border-r-0 cursor-pointer
                    ${darkMode ? 'text-white' : 'text-forestgreen'}
              ...
              <button
                ...
                className={`ml-[35px] px-[16px] py-[6px] border-2 rounded-[30px] text-[14px] font-medium cursor-pointer
                ${darkMode
                  ? 'bg-white/20 border-white/50 text-white hover:bg-white/30'
                  : 'bg-black/10 border-black/30 text-forestgreen hover:bg-black/20'
                }`}
              >
          ...
          <div className="flex-1 flex flex-col">
            {activePage === 'home' && (
              <section className="flex items-center flex-1 gap-[50px] px-[5%] py-[50px] min-h-[calc(100vh-200px)]">
                <div className="flex-1">
                  <h1
                    className="text-[55px] leading-tight font-bold"
                  ...
                  <h2
                    className="text-[30px] font-semibold mt-1"
                    style={{ color: darkMode ? 'white' : 'forestgreen' }}
                  >
                ...
                <div className="flex-shrink-0">
                  <div className="w-[28vw] h-[28vw] border-2 border-white rounded-full shadow-[0_0_20px_white] overflow-hidden relative">
                    <img
